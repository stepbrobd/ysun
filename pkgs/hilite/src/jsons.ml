                          ...
                          ; ( "endCaptures"
                            , `Assoc
                                [ ( "0"
                                  , `Assoc
                                      [ ( "name"
                                        , `String "punctuation.definition.array.end.toml"
                                        )
                                      ] )
                                ] )
                          ; "end", `String "\\]"
                          ; ( "patterns"
                            , `List
                                [ `Assoc
                                    ...
                                    ; ( "patterns"
                                      , `List
                                          [ `Assoc [ "include", `String "#primatives" ]
                                          ; `Assoc [ "include", `String "#comments" ]
                                          ; `Assoc [ "include", `String "#invalid" ]
                                          ] )
                                    ]
                                ; `Assoc [ "include", `String "#comments" ]
                                ; `Assoc [ "include", `String "#invalid" ]
                          ...
                          ; ( "beginCaptures"
                            , `Assoc
                                [ ( "0"
                                  , `Assoc
                                      [ ( "name"
                                        , `String "punctuation.definition.comment.toml" )
                                      ] )
                                ] )
                          ]
                      ] )
                ; ( "beginCaptures"
                  , `Assoc
                      [ ( "1"
                        , `Assoc
                            [ ( "name"
                              , `String "punctuation.whitespace.comment.leading.toml" )
                            ] )
                      ] )
                ] )
          ; ( "key_pair"
                ...
                [ ( "patterns"
                  , `List
                      [ `Assoc
                          ...
                          ; "end", `String "(?<=\\S)(?<!=)|$"
                          ; ( "patterns"
                            , `List [ `Assoc [ "include", `String "#primatives" ] ] )
                          ; ( "captures"
                            , `Assoc
                                [ ( "1"
                                  , `Assoc [ "name", `String "variable.other.key.toml" ] )
                                ; ( "2"
                                  , `Assoc
                                      [ ( "name"
                                        , `String "punctuation.separator.key-value.toml" )
                                      ] )
                                ] )
                          ]
                      ; `Assoc
                                      ...
                                      [ ( "patterns"
                                        , `List
                                            ...
                                            ; `Assoc
                                                [ "match", `String "\\\\[^btnfr\"\\\\]"
                                                ; ( "name"
                                                  , `String "invalid.illegal.escape.toml"
                                                  )
                                                ]
                                            ; `Assoc
                                                [ "match", `String "\""
