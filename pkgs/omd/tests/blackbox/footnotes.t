Footnote definitions on adjacent lines are all picked up.
  ...
  <div class="footnotes"><hr /><ol><li id="fn:1"><p>first note<sup><a href="#fnref-1">↩︎</a></sup></p>
  </li>
...
A definition still swallows the prose that follows it on the next line.
  ...
  <div class="footnotes"><hr /><ol><li id="fn:a"><p>the note
...
A footnote body may contain an inline link without ending the definition.
  ...
  <div class="footnotes"><hr /><ol><li id="fn:b"><p>see <a href="https://example.com/">the page</a> for more<sup><a href="#fnref-b">↩︎</a></sup></p>
  </li>
